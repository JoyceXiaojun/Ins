...
<title>Inspiration-我赞过的作品</title>
...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">我赞过的</li>
		</ol>

		<div class="row">
			<header class="page-header">
			<h2 class="page-title"><strong>我赞过的</strong></h2>
			</header>
			<!-- main content -->
			<div class="col-sm-9">
				<%
				...
				List<Work> lstWork=workBiz.findAllPraised(user.getUid());
				...
				if(lstWork==null){
					...
					%>
					<p><strong>我赞的作品总数:<%=lstWork.size() %></strong></p>
